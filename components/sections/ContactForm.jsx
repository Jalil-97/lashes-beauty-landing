          ...
          <div className="form-main">
            ...
            {step === 1 && (
              <div id="step-screen-1">
                ...
                <button className="btn btn-p btn-full" onClick={() => goStep(2)}>
                  Continuar →
                </button>
              </div>
            )}
            ...
            {step === 2 && (
              <div id="step-screen-2">
                <div className="fg">
                  ...
                  <select className="fc" value={curso} onChange={e => setCurso(e.target.value)}>
                ...
                <div className="fg">
                  ...
                  <div className="radio-group" id="nivel-group">
                    ...
                    <div
                      ...
                      onClick={() => setNivel('Lashista activa')}
                    >
                ...
                <div className="nav-btns">
                  ...
                  <button className="btn btn-p" style={{ flex: 2 }} onClick={() => goStep(3)}>Continuar →</button>
                </div>
              </div>
            )}
              ...
              <div id="step-screen-3">
                <div className="fg">
                  ...
                  <div className="pay-methods">
                    <div className={`pm${payMethod === 'card' ? ' sel' : ''}`} onClick={() => setPayMethod('card')}>
                      <div className="pm-icon">💳</div>
                      <div className="pm-label">Tarjeta / MP</div>
                    </div>
                    <div className={`pm${payMethod === 'bank' ? ' sel' : ''}`} onClick={() => setPayMethod('bank')}>
                      <div className="pm-icon">🏦</div>
                      <div className="pm-label">Transferencia</div>
                    </div>
                    <div className={`pm${payMethod === 'cash' ? ' sel' : ''}`} onClick={() => setPayMethod('cash')}>
                      <div className="pm-icon">💵</div>
                ...
                <div className="nav-btns">
                  <button className="btn btn-s" style={{ flex: 1 }} onClick={() => goStep(2)}>← Volver</button>
                  <button
                    className="btn btn-p"
